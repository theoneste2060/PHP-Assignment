            ...
            <div class="d-flex flex-row"> 
                <div class="col-sm-6">
                    <div class="form-group">
                        <div class="input-group"> <input class="form-control" type="text" placeholder="First name" name="fname"> </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <div class="input-group"> <input class="form-control" type="text" placeholder="Last name" name="lname"> </div>
                    </div>
                </div>
            </div>
           <div class="row">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="input-group"> <input class="form-control" type="text" placeholder="Choose password" name="password"> </div>
                    </div>
                </div>
            </div>
            ...
            <div class=" d-flex flex-column text-center px-5 mt-3 mb-1"></div> <button class="btn btn-primary btn-block confirm-button">Continue with google</button>
